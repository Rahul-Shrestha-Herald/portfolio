export const About = () => {
  return (
    <section id="about" className="py-20 sm:py-28 md:py-36 lg:py-40 bg-background">
      <div className="container">
        <div className="grid md:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-start">
          <div className="md:col-span-4 reveal">
            <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-olive-deep leading-[1] mb-2">
