export const Music = () => {
  return (
    <section id="music" className="py-28 md:py-36 bg-olive-deep text-cream relative overflow-hidden">
      <div className="container">
        <div className="grid md:grid-cols-12 gap-10 items-center">
          <div className="md:col-span-5 reveal">
            <h2 className="font-serif text-5xl md:text-6xl mb-6 leading-[1]">
            ...
            <div className="mt-10 flex items-center gap-3 text-[10px] uppercase tracking-[0.3em] text-cream/60">
          ...
          <div className="md:col-span-7 reveal">
            <div className="bg-cream/5 p-3 backdrop-blur-sm border border-cream/10">
              <iframe
